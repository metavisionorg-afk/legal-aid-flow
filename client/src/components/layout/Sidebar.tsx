  ...
  return (
    <div className="h-full w-64 border-r bg-sidebar flex flex-col">
      ...
      <div className="p-4 border-t border-sidebar-border">
        <Link href="/login">
          <a className="flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium text-sidebar-foreground/70 hover:bg-sidebar-accent/50 hover:text-sidebar-foreground transition-colors">
